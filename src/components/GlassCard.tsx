...
export default function GlassCard({ children, className, onClick }: GlassCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative rounded-2xl border border-mist bg-warm-white p-6 cursor-pointer transition-all duration-500 hover:border-stone/60 hover:shadow-lg hover:shadow-black/20",
        className
      )}
    >
      <motion.div
